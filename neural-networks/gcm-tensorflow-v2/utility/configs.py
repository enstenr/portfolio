...
def post_process_for_config(args, model_name):
    ...
    if args.env == 1:
        args.proj_path = '/home/btcchl0040/Documents/git-contribution/gcm-tf2/'
        args.data_path = '/home/btcchl0040/Documents/git-contribution/gcm-tf2/dataset/%s/' % args.dataset
    elif args.env == 2:
        args.proj_path = '/home/btcchl0040/Documents/git-contribution/gcm-tf2/'
        args.data_path = '/home/btcchl0040/Documents/git-contribution/gcm-tf2/dataset/%s/' % args.dataset
    else:
